...
def check_samplesheet(file_in, file_out):
    ...
    If start_basecall:
    sample_id,primary_data,polishing_1,polishing_2
    Genome1,G1_FAST5_DIR/,G1_POLISHING_R1.fastq.gz,G1_POLISHING_R2.fastq.gz
    Genome2,G2_FAST5_DIR/,G2_POLISHING_R1.fastq.gz,G2_POLISHING_R2.fastq.gz
    Genome3,G3_FAST5_DIR/,G3_POLISHING_R1.fastq.gz,G3_POLISHING_R2.fastq.gz

    If start_readqc:
    sample_id,primary_data,polishing_1,polishing_2
    Genome1,G1_NANOPORE.fastq.gz,G1_POLISHING_R1.fastq.gz,G1_POLISHING_R2.fastq.gz
    Genome2,G2_NANOPORE.fastq.gz,G2_POLISHING_R1.fastq.gz,G2_POLISHING_R2.fastq.gz
    Genome3,G3_NANOPORE.fastq.gz,G3_POLISHING_R1.fastq.gz,G3_POLISHING_R2.fastq.gz
    ...
    If start_assemblyqc:
    sample_id,primary_data,polishing_1,polishing_2
    Genome1,G1_ASSEMBLY.fasta,G1_POLISHING_R1.fastq.gz,G1_POLISHING_R2.fastq.gz
    Genome2,G2_ASSEMBLY.fasta,G2_POLISHING_R1.fastq.gz,G2_POLISHING_R2.fastq.gz
    Genome3,G3_ASSEMBLY.fasta,G3_POLISHING_R1.fastq.gz,G3_POLISHING_R2.fastq.gz

    If start_annotation:
    sample_id,primary_data,polishing_1,polishing_2
    Genome1,G1_ASSEMBLY.fasta,NA,NA
    Genome2,G1_ASSEMBLY.fasta,NA,NA
    Genome3,G1_ASSEMBLY.fasta,NA,NA
    """
    ...
    with open(file_in, "r") as fin:
        ...
        HEADER = ["sample", "primary_data", "polishing_1", "polishing_2"]
